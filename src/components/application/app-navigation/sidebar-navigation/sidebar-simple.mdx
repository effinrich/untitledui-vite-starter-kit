...
import * as SidebarSimpleStories from './sidebar-simple.stories'

<Meta of={SidebarSimpleStories} />

# SidebarSimple

The `SidebarSimple` component is a reusable UI element.

## Usage

### Basic Example

<Canvas of={SidebarSimpleStories.Default} />
...
<ArgTypes of={SidebarSimpleStories} />

This component accepts standard HTML attributes.

## Accessibility

The `SidebarSimple` component follows WAI-ARIA guidelines:
