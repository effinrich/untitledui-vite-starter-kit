...
import * as FileUploadBaseStories from './file-upload-base.stories'

<Meta of={FileUploadBaseStories} />

# FileUploadBase

The `FileUploadBase` component is a reusable UI element.

## Usage

### Basic Example

<Canvas of={FileUploadBaseStories.Default} />
...
<ArgTypes of={FileUploadBaseStories} />

This component accepts standard HTML attributes.

## Accessibility

The `FileUploadBase` component follows WAI-ARIA guidelines:
