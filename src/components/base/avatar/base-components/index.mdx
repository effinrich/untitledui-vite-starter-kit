...
import * as BaseComponentsStories from './index.stories'

<Meta of={BaseComponentsStories} />

# BaseComponents

The `BaseComponents` component is a reusable UI element.

## Usage

### Basic Example

<Canvas of={BaseComponentsStories.Default} />
...
<ArgTypes of={BaseComponentsStories} />

This component accepts standard HTML attributes.

## Accessibility

The `BaseComponents` component follows WAI-ARIA guidelines:
