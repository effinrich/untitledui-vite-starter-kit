...
import * as BadgeGroupsStories from './badge-groups.stories'

<Meta of={BadgeGroupsStories} />

# BadgeGroups

The `BadgeGroups` component is a reusable UI element.

## Usage

### Basic Example

<Canvas of={BadgeGroupsStories.Default} />
...
<ArgTypes of={BadgeGroupsStories} />

This component accepts standard HTML attributes.

## Accessibility

The `BadgeGroups` component follows WAI-ARIA guidelines:
