...
import * as AppStoreButtonsOutlineStories from './app-store-buttons-outline.stories'

<Meta of={AppStoreButtonsOutlineStories} />

# AppStoreButtonsOutline

The `AppStoreButtonsOutline` component is a reusable UI element.

## Usage

### Basic Example

<Canvas of={AppStoreButtonsOutlineStories.Default} />
...
<ArgTypes of={AppStoreButtonsOutlineStories} />

This component accepts standard HTML attributes.

## Accessibility

The `AppStoreButtonsOutline` component follows WAI-ARIA guidelines:
...
>
  Responsive AppStoreButtonsOutline
</AppStoreButtonsOutline>
