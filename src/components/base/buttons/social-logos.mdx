...
import * as SocialLogosStories from './social-logos.stories'

<Meta of={SocialLogosStories} />

# SocialLogos

The `SocialLogos` component is a reusable UI element.

## Usage

### Basic Example

<Canvas of={SocialLogosStories.Default} />
...
<ArgTypes of={SocialLogosStories} />

This component accepts standard HTML attributes.

## Accessibility

The `SocialLogos` component follows WAI-ARIA guidelines:
