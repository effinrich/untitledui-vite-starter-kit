...
import * as FileUploadTriggerStories from './file-upload-trigger.stories'

<Meta of={FileUploadTriggerStories} />

# FileUploadTrigger

The `FileUploadTrigger` component is a reusable UI element.

## Usage

### Basic Example

<Canvas of={FileUploadTriggerStories.Default} />
...
<ArgTypes of={FileUploadTriggerStories} />

This component accepts standard HTML attributes.

## Accessibility

The `FileUploadTrigger` component follows WAI-ARIA guidelines:
