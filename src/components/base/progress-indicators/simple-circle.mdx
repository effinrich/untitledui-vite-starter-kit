...
import * as SimpleCircleStories from './simple-circle.stories'

<Meta of={SimpleCircleStories} />

# SimpleCircle

The `SimpleCircle` component is a reusable UI element.

## Usage

### Basic Example

<Canvas of={SimpleCircleStories.Default} />
...
<ArgTypes of={SimpleCircleStories} />

This component accepts standard HTML attributes.

## Accessibility

The `SimpleCircle` component follows WAI-ARIA guidelines:
