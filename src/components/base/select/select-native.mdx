...
import * as SelectNativeStories from './select-native.stories'

<Meta of={SelectNativeStories} />

# SelectNative

The `SelectNative` component is a reusable UI element.

## Usage

### Basic Example

<Canvas of={SelectNativeStories.Default} />
...
<ArgTypes of={SelectNativeStories} />

This component accepts standard HTML attributes.

## Accessibility

The `SelectNative` component follows WAI-ARIA guidelines:
