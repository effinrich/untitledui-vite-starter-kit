...
import * as DotIconStories from './dot-icon.stories'

<Meta of={DotIconStories} />

# DotIcon

The `DotIcon` component is a reusable UI element.

## Usage

### Basic Example

<Canvas of={DotIconStories.Default} />
...
<ArgTypes of={DotIconStories} />

This component accepts standard HTML attributes.

## Accessibility

The `DotIcon` component follows WAI-ARIA guidelines:
