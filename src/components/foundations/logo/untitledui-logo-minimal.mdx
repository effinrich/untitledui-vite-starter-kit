...
import * as UntitleduiLogoMinimalStories from './untitledui-logo-minimal.stories'

<Meta of={UntitleduiLogoMinimalStories} />

# UntitleduiLogoMinimal

The `UntitleduiLogoMinimal` component is a reusable UI element.

## Usage

### Basic Example

<Canvas of={UntitleduiLogoMinimalStories.Default} />
...
<ArgTypes of={UntitleduiLogoMinimalStories} />

This component accepts standard HTML attributes.

## Accessibility

The `UntitleduiLogoMinimal` component follows WAI-ARIA guidelines:
...
>
  Responsive UntitleduiLogoMinimal
</UntitleduiLogoMinimal>
