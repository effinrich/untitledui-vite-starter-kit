...
import * as UntitleduiLogoStories from './untitledui-logo.stories'

<Meta of={UntitleduiLogoStories} />

# UntitleduiLogo

The `UntitleduiLogo` component is a reusable UI element.

## Usage

### Basic Example

<Canvas of={UntitleduiLogoStories.Default} />
...
<ArgTypes of={UntitleduiLogoStories} />

This component accepts standard HTML attributes.

## Accessibility

The `UntitleduiLogo` component follows WAI-ARIA guidelines:
