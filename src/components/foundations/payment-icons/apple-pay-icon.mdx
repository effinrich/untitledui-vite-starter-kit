...
import * as ApplePayIconStories from './apple-pay-icon.stories'

<Meta of={ApplePayIconStories} />

# ApplePayIcon

The `ApplePayIcon` component is a reusable UI element.

## Usage

### Basic Example

<Canvas of={ApplePayIconStories.Default} />
...
<ArgTypes of={ApplePayIconStories} />

This component accepts standard HTML attributes.

## Accessibility

The `ApplePayIcon` component follows WAI-ARIA guidelines:
