...
import * as DiscoverIconStories from './discover-icon.stories'

<Meta of={DiscoverIconStories} />

# DiscoverIcon

The `DiscoverIcon` component is a reusable UI element.

## Usage

### Basic Example

<Canvas of={DiscoverIconStories.Default} />
...
<ArgTypes of={DiscoverIconStories} />

This component accepts standard HTML attributes.

## Accessibility

The `DiscoverIcon` component follows WAI-ARIA guidelines:
