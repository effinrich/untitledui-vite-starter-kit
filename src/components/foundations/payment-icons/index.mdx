...
import * as PaymentIconsStories from './index.stories'

<Meta of={PaymentIconsStories} />

# PaymentIcons

The `PaymentIcons` component is a reusable UI element.

## Usage

### Basic Example

<Canvas of={PaymentIconsStories.Default} />
...
<ArgTypes of={PaymentIconsStories} />

This component accepts standard HTML attributes.

## Accessibility

The `PaymentIcons` component follows WAI-ARIA guidelines:
