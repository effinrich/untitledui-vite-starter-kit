...
import * as MastercardIconStories from './mastercard-icon.stories'

<Meta of={MastercardIconStories} />

# MastercardIcon

The `MastercardIcon` component is a reusable UI element.

## Usage

### Basic Example

<Canvas of={MastercardIconStories.Default} />
...
<ArgTypes of={MastercardIconStories} />

This component accepts standard HTML attributes.

## Accessibility

The `MastercardIcon` component follows WAI-ARIA guidelines:
