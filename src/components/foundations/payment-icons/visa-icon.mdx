...
import * as VisaIconStories from './visa-icon.stories'

<Meta of={VisaIconStories} />

# VisaIcon

The `VisaIcon` component is a reusable UI element.

## Usage

### Basic Example

<Canvas of={VisaIconStories.Default} />
...
<ArgTypes of={VisaIconStories} />

This component accepts standard HTML attributes.

## Accessibility

The `VisaIcon` component follows WAI-ARIA guidelines:
