...
import * as AppleStories from './apple.stories'

<Meta of={AppleStories} />

# Apple

The `Apple` component provides configurable sizes.

## Usage

### Basic Example

<Canvas of={AppleStories.Default} />
...
The `Apple` component follows WAI-ARIA guidelines:
