...
import * as DiscordStories from './discord.stories'

<Meta of={DiscordStories} />

# Discord

The `Discord` component provides configurable sizes.

## Usage

### Basic Example

<Canvas of={DiscordStories.Default} />
...
The `Discord` component follows WAI-ARIA guidelines:
