...
import * as DribbbleStories from './dribbble.stories'

<Meta of={DribbbleStories} />

# Dribbble

The `Dribbble` component provides configurable sizes.

## Usage

### Basic Example

<Canvas of={DribbbleStories.Default} />
...
The `Dribbble` component follows WAI-ARIA guidelines:
