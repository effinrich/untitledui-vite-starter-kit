...
import * as FacebookStories from './facebook.stories'

<Meta of={FacebookStories} />

# Facebook

The `Facebook` component provides configurable sizes.

## Usage

### Basic Example

<Canvas of={FacebookStories.Default} />
...
The `Facebook` component follows WAI-ARIA guidelines:
