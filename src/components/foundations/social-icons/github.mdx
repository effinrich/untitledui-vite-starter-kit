...
import * as GithubStories from './github.stories'

<Meta of={GithubStories} />

# Github

The `Github` component provides configurable sizes.

## Usage

### Basic Example

<Canvas of={GithubStories.Default} />
...
The `Github` component follows WAI-ARIA guidelines:
