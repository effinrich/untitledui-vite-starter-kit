...
import * as PinterestStories from './pinterest.stories'

<Meta of={PinterestStories} />

# Pinterest

The `Pinterest` component provides configurable sizes.

## Usage

### Basic Example

<Canvas of={PinterestStories.Default} />
...
The `Pinterest` component follows WAI-ARIA guidelines:
