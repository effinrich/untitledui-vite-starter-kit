...
import * as SignalStories from './signal.stories'

<Meta of={SignalStories} />

# Signal

The `Signal` component provides configurable sizes.

## Usage

### Basic Example

<Canvas of={SignalStories.Default} />
...
The `Signal` component follows WAI-ARIA guidelines:
