...
import * as SnapchatStories from './snapchat.stories'

<Meta of={SnapchatStories} />

# Snapchat

The `Snapchat` component provides configurable sizes.

## Usage

### Basic Example

<Canvas of={SnapchatStories.Default} />
...
The `Snapchat` component follows WAI-ARIA guidelines:
