...
import * as TelegramStories from './telegram.stories'

<Meta of={TelegramStories} />

# Telegram

The `Telegram` component provides configurable sizes.

## Usage

### Basic Example

<Canvas of={TelegramStories.Default} />
...
The `Telegram` component follows WAI-ARIA guidelines:
