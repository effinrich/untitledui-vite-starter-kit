...
import * as TumblrStories from './tumblr.stories'

<Meta of={TumblrStories} />

# Tumblr

The `Tumblr` component provides configurable sizes.

## Usage

### Basic Example

<Canvas of={TumblrStories.Default} />
...
The `Tumblr` component follows WAI-ARIA guidelines:
