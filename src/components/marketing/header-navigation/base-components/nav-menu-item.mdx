...
import * as NavMenuItemStories from './nav-menu-item.stories'

<Meta of={NavMenuItemStories} />

# NavMenuItem

The `NavMenuItem` component is a reusable UI element.

## Usage

### Basic Example

<Canvas of={NavMenuItemStories.Default} />
...
<ArgTypes of={NavMenuItemStories} />

This component accepts standard HTML attributes.

## Accessibility

The `NavMenuItem` component follows WAI-ARIA guidelines:
