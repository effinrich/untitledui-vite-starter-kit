...
import * as DropdownHeaderNavigationStories from './dropdown-header-navigation.stories'

<Meta of={DropdownHeaderNavigationStories} />

# DropdownHeaderNavigation

The `DropdownHeaderNavigation` component is a reusable UI element.

## Usage

### Basic Example

<Canvas of={DropdownHeaderNavigationStories.Default} />
...
<ArgTypes of={DropdownHeaderNavigationStories} />

This component accepts standard HTML attributes.

## Accessibility

The `DropdownHeaderNavigation` component follows WAI-ARIA guidelines:
...
>
  Responsive DropdownHeaderNavigation
</DropdownHeaderNavigation>
