...
import * as DocumentsStories from './documents.stories'

<Meta of={DocumentsStories} />

# Documents

The `Documents` component is a reusable UI element.

## Usage

### Basic Example

<Canvas of={DocumentsStories.Default} />
...
<ArgTypes of={DocumentsStories} />

This component accepts standard HTML attributes.

## Accessibility

The `Documents` component follows WAI-ARIA guidelines:
