...
import * as IllustrationsStories from './index.stories'

<Meta of={IllustrationsStories} />

# Illustrations

The `Illustrations` component is a reusable UI element.
...
<ArgTypes of={IllustrationsStories} />

This component accepts standard HTML attributes.

## Accessibility

The `Illustrations` component follows WAI-ARIA guidelines:
