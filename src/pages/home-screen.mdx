...
import * as HomeScreenStories from './home-screen.stories'

<Meta of={HomeScreenStories} />

# HomeScreen

The `HomeScreen` component is a reusable UI element.

## Usage

### Basic Example

<Canvas of={HomeScreenStories.Default} />
...
<ArgTypes of={HomeScreenStories} />

This component accepts standard HTML attributes.

## Accessibility

The `HomeScreen` component follows WAI-ARIA guidelines:
