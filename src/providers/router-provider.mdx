...
import * as RouterProviderStories from './router-provider.stories'

<Meta of={RouterProviderStories} />

# RouterProvider

The `RouterProvider` component is a reusable UI element.

## Usage

### Basic Example

<Canvas of={RouterProviderStories.Default} />
...
<ArgTypes of={RouterProviderStories} />

This component accepts standard HTML attributes.

## Accessibility

The `RouterProvider` component follows WAI-ARIA guidelines:
